                            ...
                            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                                <div class="col-lg-7" id="forum-img">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div id="discussion">
                                            <p class="text-white overflow-y-auto">{{ $forum->discussion }}</p>
                                        </div>
                                        ...
                                        <a id="principal" href="{{ route('mypage', ['user' => $user['id']]) }}">
                                        <div class="text-white fs-5">
                                            @if( $user['image'] ==null)
                                                <img id="forunUserIcon" class="img-profile rounded-circle" src="{{ asset('storage/kkrn_icon_user_4.png')}}" alt="..." />
                                            @else
                                                <img id="forunUserIcon" class="img-profile rounded-circle" src="{{ asset( 'storage/' . $user['image'] ) }}" alt="...">
                                            @endif
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            ...
                                            <div class="card-footer">
                                                <a class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#{{ $comment['id'] }}" href="#">返信する</a>
                                            </div>
                                    </div>
