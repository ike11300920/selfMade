                ...
                <div class="row justify-content-around my-5">
                    ...
                    <div class="col-md-4 text-center row align-items-center" cz-shortcut-listen="true">
                        <div class="card bg-dark">
                            ...
                            <div class="card-body">
                                <div class="col p-2"><input type="email" id="inputEmail" class="form-control" placeholder="ユーザー名" required="" autofocus=""></div>
                                <div class="col p-2"><input type="password" id="inputPassword" class="form-control" placeholder="メールアドレス" required=""></div>
